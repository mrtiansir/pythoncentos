...
def netconf_ospf_process_router_id(ip, username, password, process_id, router_id, port='830'):
              ...
              <native xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-native" xmlns:ios-ospf="http://cisco.com/ns/yang/Cisco-IOS-XE-ospf">
                <router>
                  <ios-ospf:ospf>
                    ...
                    <ios-ospf:router-id>1.1.1.1</ios-ospf:router-id>
                  </ios-ospf:ospf>
                </router>
              </native>
            </config>
    ...
    for router_id_xml in root.iter("{http://cisco.com/ns/yang/Cisco-IOS-XE-ospf}router-id"):
        router_id_xml.text = router_id
    # 打印最终生成的XML
...
if __name__ == '__main__':
    print(netconf_ospf_process_router_id('10.1.1.253', 'admin', 'Cisc0123', 1, '1.1.1.1'))
